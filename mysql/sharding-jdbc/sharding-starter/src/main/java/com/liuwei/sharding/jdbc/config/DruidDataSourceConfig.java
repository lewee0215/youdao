...
import com.liuwei.sharding.jdbc.config.rule.ModuloTableShardingAlgorithm;
...
public class DruidDataSourceConfig{
    ...
    private DataSourceRule dataSourceRule(){
        ...
        dataSourceMap.put("ds_0", createDataBase("ds_0"));
    ...
    private DataSource createDataBase(final String dataSourceName) {
        DruidDataSource druidDataSource = new DruidDataSource();
        druidDataSource.setDriverClassName(druidProperties.getDriverClassName());
        druidDataSource.setUrl(druidProperties.getUrl());
        druidDataSource.setUsername(druidProperties.getUsername());
    ...
    private TableRule tableRule(DataSourceRule dataSourceRule){
